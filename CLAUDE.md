...
- [ ] **2.1** Create `tools/analyze.py` — orchestrates the analysis pipeline:
...
- [ ] **2.2** Implement fallback analysis using `ps2xAnalyzer`:
...
- [ ] **2.3** Implement `make_function_map()`:
...
- [ ] **2.4** Implement `prepare_recomp_config()`:
...
- [ ] **2.5** Document the complete analysis pipeline in `docs/analysis.md`:
